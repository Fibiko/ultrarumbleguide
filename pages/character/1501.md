...
Both gamma 1 and 2s movement are momentum based, however this matters more for gamma 1. If you start a dash jump and gamma directly at the start you will go further than if you were standing still or just dashing. Using gamma 1 mid-air after using another or collapse hand will result in shig not going very far compared to dashing or dash jumping like I mentioned prior. Gamma 2's fall can be controlled by positioning the camera before it starts. Looking up makes you fall slower and gives you more height. Looking down makes you fall faster and less height from the flip. This gamma, of course, doesn't care what the laws of momentum think is impossible because standing perfectly still then using gamma gets you the most distance since it slides shig mid-air.
<p align="center">
...
This adds 200 to the combo meter while applying a defense debuff. The defense debuff allows it to scare people off of you since it just makes assault shig comboing someone to death faster. On the ground the tracking is pretty similar to melee 3 making it solid for catching wake ups. The aerial version has a little bit of start lag compared to the grounded version but has much more aggressive tracking making it arguably his best wake up call out option. The air version reliably allows follow ups such as air melee, beta, gamma or a second collapse hand. If it isn't tracking a target the air version will usually go the direction your camera is looking. On 60 that is consistent but with higher framerates you can influence it to go other directions. As of season 14 special action can no longer be ledge cancelled due to changes.
<p align="center">
